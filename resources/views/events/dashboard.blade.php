...
@section('content')
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
            <p>Você ainda não possui eventos, <a href="/eventos/criar">criar evento</a></p>
        @endif
    </div>
    <div class="col-md-10 offset-md-1 dashboard-title-container">
    ...
    <div class="col-md-10 offset-md-1 dashboard-events-container">
        ...
        @else
            <p>Você ainda não está participando de nenhum evento, <a href="/">vjea todos os eventos</a></p>
        @endif
    </div>
@endsection
